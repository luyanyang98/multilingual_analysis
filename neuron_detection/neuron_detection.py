...
def main(argv):
    ...
    if not activate_keys_set_fwd_up:
        logging.warning("No successful activations collected; skipping intersection.")
    else:
